 ...
 */
async function createAsset(contract: Contract, id: string, type: string, size: string, owner: string) : Promise<void> {
    console.log('\n--> Submit Transaction: CreateAsset, creates new asset with ID, Type, Size, Owner arguments');
...
async function readAssetByID(contract: Contract, id:string): Promise<JSON> {
